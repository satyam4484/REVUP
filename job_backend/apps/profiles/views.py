...
def jobPreferenceView(request,id=None):
    if request.method == "GET":
        try:
            if id:
                jb = jobPreference.objects.get(id = id)
                serializer = jobPreferenceSerializer(jb)
                return content(False,"","",serializer.data)
            else:
                jb =jobPreference.objects.filter(user__user = request.user)
                serializer = jobPreferenceSerializer(jb,many=True)
                return content(False,"","",serializer.data)        
        except Exception as e:
            return content(True,str(e),"Getting Job Preference")
        ...
        try:
            ...
            return content(True,str(e),"Adding Job Preference")
    elif request.method == "PATCH":
        try:
            if id:
                jb = jobPreference.objects.get(id = id)
                data = request.data 
                serializer = jobPreferenceSerializer(instance=jb,data=data,partial = True)
                if serializer.is_valid(raise_exception=True):
                    serializer.save(user__user = request.user)
                    return content(False,"","",serializer.data)
            else :
                raise Exception("Invalid Id")
        except Exception as e:
            return content(True,str(e),"Updating Job Preference")
    else:
        try:
            if id:
                print(id)
                jb = jobPreference.objects.get(id = id)
                jb.delete()
                return content(False,"Preference Deleted","")
            else:
                raise Exception("Invalid Id")
        except Exception as e:
            return content(True,str(e),"Deleting Job Preference")
...
# this view handle user as well as organization profile
...
def ProfileView(request):
    if request.method == "GET":
        try:
            ...
            return content(True,str(e),"getting profile")
    elif request.method == "POST":
        try:
            data = request.data 
            ...
            return content(True,str(e),"adding profile")
    else:
        try:
            data = request.data
            ...
            if request.user.usertype == 1:
                ...
                profile = organization.objects.get(company=request.user)
                serializer = organizationSerializer(instance=profile,data=data,partial=True,context={"request":request})
            if serializer.is_valid(raise_exception=True):
                serializer.save()
                return content(False,"","",serializer.data)
            raise Exception(serializer.errors)
        except Exception as e:
            return content(True,str(e),"updating profile")
...
def contactView(request):
    if request.method == "GET":
        try:
            con  = userProfile.objects.get(user = request.user) 
            serializer = contactSerializer(con.contactDetails)
            return content(False,"","",serializer.data)
        except Exception as e:
