...
const MyNavbar = () => {
  const { isLoggedIn,user,userLogout,setSearch,search } = useGlobalContext();
      ...
      <Container fluid>
        ...
        >
          ...
          <Offcanvas.Body>
            ...
            <Nav className="justify-content-end flex-grow-1 pe-3 mx-auto">
            ...
            {isLoggedIn && <Nav className="justify-content-center flex-grow-1">
              <li className="nav-item dropdown-center dropdown">
                ...
                <ul className="dropdown-menu">
                  ...
                  {user.usertype === 1 && <li><NavLink to={`/profile/${user.email}/jobPrefernce`} className={`dropdown-item ${(isActive) => isActive ? "active" : ""}`}>Job Preference</NavLink></li>}
